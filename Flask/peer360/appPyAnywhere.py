...
UPLOAD_FOLDER = '/home/raulmllorente/mysite/uploads'
...
app.config['SQLALCHEMY_DATABASE_URI'] = 'sqlite:////home/raulmllorente/mysite/database/user.db'
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

import json
with open('/home/raulmllorente/mysite/configuration.json') as json_file:
...
def upload_file():
    if request.method == 'POST':
        ...
        if file and allowed_file(file.filename):
            ...
            df_original = pd.read_excel(os.path.join(app.config['UPLOAD_FOLDER'], filename), engine='openpyxl')
