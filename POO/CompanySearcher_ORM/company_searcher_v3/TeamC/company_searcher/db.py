...
engine = create_engine("mysql+mysqlconnector://{username}:{password}@{hostname}/{databasename}?auth_plugin=mysql_native_password".format(
...
for i in range(len(df)):
    company = Balancesheet(nif_fical_number_id=df['nif_fical_number_id'].iloc[i],
                           ...
                           p10000_TotalAssets_h0=float(df['p10000_TotalAssets_h0'].iloc[i]),
                           p10000_TotalAssets_h1=float(df['p10000_TotalAssets_h1'].iloc[i]),
                           p10000_TotalAssets_h2=float(df['p10000_TotalAssets_h2'].iloc[i]),
                           p20000_OwnCapital_h0=float(df['p20000_OwnCapital_h0'].iloc[i]),
                           p20000_OwnCapital_h1=float(df['p20000_OwnCapital_h1'].iloc[i]),
                           p20000_OwnCapital_h2=float(df['p20000_OwnCapital_h2'].iloc[i]),
                           p31200_ShortTermDebt_h0=float(df['p31200_ShortTermDebt_h0'].iloc[i]),
                           p31200_ShortTermDebt_h1=float(df['p31200_ShortTermDebt_h1'].iloc[i]),
                           p31200_ShortTermDebt_h2=float(df['p31200_ShortTermDebt_h2'].iloc[i]),
                           p32300_LongTermDebt_h0=float(df['p32300_LongTermDebt_h0'].iloc[i]),
                           p32300_LongTermDebt_h1=float(df['p32300_LongTermDebt_h1'].iloc[i]),
                           p32300_LongTermDebt_h2=float(df['p32300_LongTermDebt_h2'].iloc[i]),
                           p40100_40500_SalesTurnover_h0=float(df['p40100_40500_SalesTurnover_h0'].iloc[i]),
                           p40100_40500_SalesTurnover_h1=float(df['p40100_40500_SalesTurnover_h1'].iloc[i]),
                           p40100_40500_SalesTurnover_h2=float(df['p40100_40500_SalesTurnover_h2'].iloc[i]),
                           p40800_Amortization_h0=float(df['p40800_Amortization_h0'].iloc[i]),
                           p40800_Amortization_h1=float(df['p40800_Amortization_h1'].iloc[i]),
                           p40800_Amortization_h2=float(df['p40800_Amortization_h2'].iloc[i]),
                           p49100_Profit_h0=float(df['p49100_Profit_h0'].iloc[i]),
                           p49100_Profit_h1=float(df['p49100_Profit_h1'].iloc[i]),
                           p49100_Profit_h2=float(df['p49100_Profit_h2'].iloc[i]),
